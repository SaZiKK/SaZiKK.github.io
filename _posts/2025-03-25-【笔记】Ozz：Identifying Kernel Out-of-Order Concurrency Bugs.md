...
> 题外话
> 又读了不少文章之后，我终于可以回答一个问题了，为什么 OZZ 可以拿 best paper，因为许多工作都集中于如何在现有子领域内中，基于已有工作的思路修改，去获取一个更好的 prof，在 idea 上相对都比较自然，在工程实现上的工作量相对比较多，而在 OoO 问题的自动化测试领域上，OZZ 突破性的提出了通过控制访存来等价的控制乱序执行，从根本上提出了另一种可能性，idea 上就让人眼前一亮。